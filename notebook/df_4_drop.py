...
to_drop = ['case:dec_id_5', 'case:dec_id_6',
       ...
       'case:OrganizationalEntity_1', 'case:Cost_Type_1',
       'case:Cost_Type_0', 'case:Task_1', 'case:Task_0', 'case:Project_0',
       'case:Rfp_id_1', 'case:Project_1', 'case:Activity_3',
       'case:Activity_2', 'case:Cost_Type_3', 'case:Cost_Type_2',
       ...
       'case:Cost_Type_7', 'case:Cost_Type_6', 'case:Cost_Type_9',
       'case:Cost_Type_8', 'case:Cost_Type_5', 'case:Cost_Type_4',
       ...
       'case:Cost_Type_13', 'case:Cost_Type_14', 'case:Cost_Type_10',
       'case:Cost_Type_11', 'case:Cost_Type_12', 'case:Task_5',
